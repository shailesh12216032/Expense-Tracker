...
names = ["Shailesh", "Admin"]
usernames = ["shailesh", "admin"]
passwords = ["abc123", "adminpass"]  # Plain passwords (for demo only)
...
# If authentication fails or is None, show the login form
...
# If authenticated, proceed to the app
